...
const ReachUsOut: FunctionComponent<Props> = async ({ locale }) => {
	...
	return (
		<LabFooterBlock id="social_links" title={t('ReachOutTitle')}>
			<div className="flex flex-wrap gap-3">
				<LabIconAction aria-label="GitHub" href="https://github.com/RevoTale" locale={locale} title={t('GithubAlt')}>
					<svg className="size-6" aria-hidden="true" height="90" viewBox="0 0 14 14" width="90">
						<path
				...
				<LabIconAction aria-label="Twitter" href="https://twitter.com/RevoTale" locale={locale} title={t('TwitterAlt')}>
					<svg className="size-6" aria-hidden="true" fill="currentColor" height="16" width="16" viewBox="0 0 18 15">
						<path
