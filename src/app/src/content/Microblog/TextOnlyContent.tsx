...
const TextOnlyContent: FunctionComponent<Props> = ({markdown, locale}) => {
	...
	const components: Partial<Components> = {
		...
		h1: ({children}) => (
			<h2
				className={cn(
					'leading-tight text-lg font-bold mt-1',
					'text-lg'
				)}>
				{children}
			</h2>
		...
		h2: ({children}) => (
			<h3
				className={cn(
					'leading-tight text-base font-semibold mt-1',
					'text-base'
				)}>
				{children}
			</h3>
		...
		h3: ({children}) => (
			<h4 className="leading-tight text-base font-bold mt-1 ">
				{children}
			</h4>
		),
		h4: ({children}) => (
			<h5 className="leading-tight text-base font-bold mt-2 ">
				{children}
			</h5>
		),
		h5: ({children}) => (
			<h6 className="leading-tight text-base font-bold mt-2 ">
				{children}
			</h6>
		),
		blockquote: ({children}) => (
	...
	return (
		<div
			className={cn(
				'my-3 text-foreground leading-normal [&>*+*]:mt-3 [&>li+li]:mt-3 [&>li>p+*]:mt-3',
				'text-sm'
			)}>
			<Markdown
