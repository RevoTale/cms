			...
			<div className="container mx-auto px-4">
				<div className="mx-auto max-w-3xl">
					<Card className="overflow-hidden pt-0 pb-5">
						<CardHeader className="bg-linear-to-r from-primary/5 to-accent/5 py-6">
							...
							<CardDescription className="text-center">
								I&apos;m open for communication, offers and collaboration
							</CardDescription>
						</CardHeader>
						<CardContent className="pt-6">
							{/* Primary Contact Options */}
							<div className="grid gap-4 sm:grid-cols-2">
								<ContactButton href="https://github.com/l-you" icon={<GitHubIcon />} title="GitHub" subtitle="@l-you" />
								<ContactButton
								...
								/>
								<ContactButton href="https://x.com/x_l_you" icon={<XIcon />} title="X (Twitter)" subtitle="@x_l_you" />
								<ContactButton
							...
							{/* Expandable section */}
							<div className="mt-6">
								<Button variant="ghost" className="w-full gap-2" onClick={handleToggle}>
					...
					<div className="mt-12 text-center">
						<p className="italic text-muted-foreground">&quot;Made with passion ❤️‍🔥&quot;</p>
						<p className="mt-2 text-sm text-muted-foreground">RevoTale · Elegant solutions for challenging tasks</p>
					</div>
				</div>
			</div>
		</section>
...
const ContactButton: FunctionComponent<ContactButtonProps> = ({ href, icon, title, subtitle, variant = 'outline' }) => {
	return (
		<Button asChild variant={variant} className="h-auto justify-start gap-3 p-4">
