...
const iconMap: Record<TechIconName, string> = {
	...
	payloadcms: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-original.svg',
...
export const TechIcon: FunctionComponent<TechIconProps> = ({ name, className = 'size-4' }) => {
	...
	return (
		...
		/* biome-ignore lint/performance/noImgElement: these tiny external CDN icons are intentionally rendered without next/image optimization */
		<img src={iconUrl} alt={`${name} icon`} className={className} loading="lazy" />
	)
}

// Social Icons as SVG components
export const GitHubIcon: FunctionComponent<{ className?: string }> = ({ className }) => (
...
export const RedditIcon: FunctionComponent<{ className?: string }> = ({ className }) => (
	<svg className={cn('size-5', className)} viewBox="0 0 24 24" fill="currentColor">
		<title>Reddit</title>
...
export const NpmIcon: FunctionComponent<{ className?: string }> = ({ className }) => (
	<svg className={cn('size-5', className)} viewBox="0 0 24 24" fill="currentColor">
		<title>NPM</title>
...
export const PackagistIcon: FunctionComponent<{ className?: string }> = ({ className }) => (
	<svg className={cn('size-5', className)} viewBox="0 0 24 24" fill="currentColor">
...
export const StarIcon: FunctionComponent<{ className?: string }> = ({ className }) => (
...
export const TechCategory: FunctionComponent<TechCategoryProps> = ({ icon, title, techs }) => {
	return (
		<div className="space-y-4">
			...
			<div className="flex flex-wrap gap-3">
				{techs.map(tech => (
					<Badge key={tech.name} variant="secondary" className="gap-2 px-3 py-1.5 text-sm">
