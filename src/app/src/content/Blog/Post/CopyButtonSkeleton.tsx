...
const CopyButtonSkeleton: FunctionComponent<Props & VariantProps<typeof buttonVariants>> = ({
	className,
	disableText = false,
	variant,
	copyText,
	...
	return (
		...
		>
			<CopyIcon />
			{disableText ? null : <span className="text-xs text-muted-foreground">{copyText}</span>}
		</Button>
	)
}
