...
const MicroblogListWithDataHorizontalSkeleton: FunctionComponent<Props> = ({
	className,
}) => {
	return (
				...
				<div className="overflow-hidden">
					<div className="flex -ml-4">
						{Array.from({length: 6}).map((_, index) => (
							<div
								className="min-w-0 shrink-0 grow-0 pl-4 basis-64 max-w-full justify-center flex w-full"
								key={index}>
								<MicroblogListItem
